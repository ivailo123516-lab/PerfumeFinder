...
PerfumeFinder is a sample full-stack project with a .NET 8 Web API backend and a React frontend. The API includes JWT authentication, EF Core with SQLite, seed data and Swagger. The frontend is a small React app that consumes the API.
...
- The API will create a SQLite DB file perfume.db in the API project folder on first run
